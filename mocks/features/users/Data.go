...
func (_m *Data) DeleteUser(ctx context.Context, id uint) (users.Core, error) {
...
func (_m *Data) GetAllUser(ctx context.Context) ([]users.Core, error) {
	ret := _m.Called(ctx)
...
func (_m *Data) GetUserByAdminStatus(ctx context.Context, status string) ([]users.Core, error) {
...
func (_m *Data) GetUserByID(ctx context.Context, id uint) (users.Core, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Data) LoginUser(ctx context.Context, data users.Core) (users.Core, error) {
...
func (_m *Data) RegisterUser(ctx context.Context, data users.Core) (users.Core, error) {
	ret := _m.Called(ctx, data)
...
func (_m *Data) SearchUserByName(ctx context.Context, name string) ([]users.Core, error) {
...
func (_m *Data) UpdateUser(ctx context.Context, data users.Core) (users.Core, error) {
	ret := _m.Called(ctx, data)
