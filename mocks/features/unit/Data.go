...
func (_m *Data) AddFacilityToUnit(c context.Context, unitId uint, facilityId uint) (unit.Facility, error) {
...
func (_m *Data) CreateInteriorPhoto(ctx context.Context, photo unit.InteriorCore) (unit.InteriorCore, error) {
...
func (_m *Data) CreateUnit(ctx context.Context, _a1 unit.Core) (unit.Core, error) {
...
func (_m *Data) DeleteInteriorPhoto(ctx context.Context, UnitId uint, photoId uint) (unit.InteriorCore, error) {
...
func (_m *Data) DeleteUnitFacility(ctx context.Context, unitId uint, facilityId uint) (unit.Core, error) {
...
func (_m *Data) GetAllInteriorPhoto(ctx context.Context, UnitId uint) ([]unit.InteriorCore, error) {
...
// GetAllUnit provides a mock function with given fields: ctx, complexId
func (_m *Data) GetAllUnit(ctx context.Context, complexId uint) ([]unit.Core, error) {
...
func (_m *Data) GetAllUnitFacility(c context.Context, unitId uint) (unit.Core, error) {
...
func (_m *Data) GetInteriorPhoto(ctx context.Context, UnitId uint, photoId uint) (unit.InteriorCore, error) {
	ret := _m.Called(ctx, UnitId, photoId)
...
func (_m *Data) GetUnitById(ctx context.Context, buildingId uint, facilityId uint) (unit.Core, error) {
...
func (_m *Data) GetUnitByType(ctx context.Context, buildingId uint, unitType string) (unit.Core, error) {
...
func (_m *Data) GetUnitFacility(ctx context.Context, unitId uint, facilityId uint) (unit.Facility, error) {
	ret := _m.Called(ctx, unitId, facilityId)
...
func (_m *Data) UpdateInteriorPhoto(ctx context.Context, photo unit.InteriorCore) (unit.InteriorCore, error) {
	ret := _m.Called(ctx, photo)
...
func (_m *Data) UpdateUnit(ctx context.Context, _a1 unit.Core) (unit.Core, error) {
	ret := _m.Called(ctx, _a1)
