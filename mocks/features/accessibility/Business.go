...
func (_m *Business) CreateAccessibility(ctx context.Context, _a1 accessibility.Core) (accessibility.Core, error) {
...
func (_m *Business) GetAccessibility(ctx context.Context, id uint) (accessibility.Core, error) {
...
func (_m *Business) RequestAccessibility(ctx context.Context, id uint, name string) (accessibility.Core, error) {
...
func (_m *Business) SearchAccessibility(ctx context.Context, name string) ([]accessibility.Core, error) {
...
func (_m *Business) SearchAccessibilityByAddress(ctx context.Context, address string) ([]accessibility.Core, error) {
...
func (_m *Business) UpdateAccessibility(ctx context.Context, _a1 accessibility.Core) (accessibility.Core, error) {
	ret := _m.Called(ctx, _a1)
