...
func (_m *Business) AddFacilityToBuilding(c context.Context, facilityId uint, buildingId uint) (building.Facility, error) {
...
func (_m *Business) CreateBuilding(ctx context.Context, _a1 building.Core) (building.Core, error) {
...
func (_m *Business) CreateExteriorPhoto(ctx context.Context, photo building.ExteriorCore) (building.ExteriorCore, error) {
...
func (_m *Business) CreateFloorPhoto(ctx context.Context, photo building.FloorCore) (building.FloorCore, error) {
	ret := _m.Called(ctx, photo)
...
func (_m *Business) DeleteExteriorPhoto(ctx context.Context, BuildingId uint, photoId uint) (building.ExteriorCore, error) {
...
func (_m *Business) DeleteFacility(c context.Context, buildingId uint, facilityId uint) (building.Core, error) {
...
func (_m *Business) DeleteFloorPhoto(ctx context.Context, BuildingId uint, photoId uint) (building.FloorCore, error) {
	ret := _m.Called(ctx, BuildingId, photoId)
...
func (_m *Business) GetAllBuilding(ctx context.Context, complexId uint) ([]building.Core, error) {
...
func (_m *Business) GetAllBuildingFacility(c context.Context, buildingId uint) (building.Core, error) {
...
func (_m *Business) GetAllExteriorPhoto(ctx context.Context, BuildingId uint) ([]building.ExteriorCore, error) {
...
func (_m *Business) GetAllFloorPhoto(ctx context.Context, BuildingId uint) ([]building.FloorCore, error) {
	ret := _m.Called(ctx, BuildingId)
...
func (_m *Business) GetAllVerifiedBuilding(ctx context.Context, complexId uint, buildingStatus string) ([]building.Core, error) {
...
func (_m *Business) GetBuildingById(ctx context.Context, id uint) (building.Core, error) {
...
func (_m *Business) GetBuildingFacility(c context.Context, buildingId uint, facilityId uint) (building.Facility, error) {
	ret := _m.Called(c, buildingId, facilityId)
...
func (_m *Business) GetExteriorPhoto(ctx context.Context, BuildingId uint, photoId uint) (building.ExteriorCore, error) {
	ret := _m.Called(ctx, BuildingId, photoId)
...
func (_m *Business) GetFloorPhoto(ctx context.Context, BuildingId uint, photoId uint) (building.FloorCore, error) {
	ret := _m.Called(ctx, BuildingId, photoId)
...
func (_m *Business) SearchBuildingByName(ctx context.Context, name string, status string) ([]building.Core, error) {
...
func (_m *Business) UpdateBuilding(ctx context.Context, _a1 building.Core) (building.Core, error) {
	ret := _m.Called(ctx, _a1)
...
func (_m *Business) UpdateExteriorPhoto(ctx context.Context, photo building.ExteriorCore) (building.ExteriorCore, error) {
	ret := _m.Called(ctx, photo)
...
func (_m *Business) UpdateFloorPhoto(ctx context.Context, photo building.FloorCore) (building.FloorCore, error) {
	ret := _m.Called(ctx, photo)
