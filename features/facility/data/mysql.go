...
func (cd *facilityData) CreateFacility(ctx context.Context, core facility.Core) (facility.Core, error) {
	facility1 := fromFacilityCore(core)
	result := cd.Connect.Create(&facility1)
	if result.Error != nil {
		return facility.Core{}, result.Error
	}
	return toFacilityCore(facility1), nil
}

func (cd *facilityData) GetFacility(ctx context.Context, id uint) (facility.Core, error) {
...
func (cd *facilityData) SearchFacility(ctx context.Context, name string) ([]facility.Core, error) {
	var facility1 []Facility
...
func (cd *facilityData) UpdateFacility(ctx context.Context, core facility.Core) (facility.Core, error) {
	facility1 := fromFacilityCore(core)
...
func (cd *facilityData) DeleteFacility(ctx context.Context, id uint) (facility.Core, error) {
	var fac Facility
