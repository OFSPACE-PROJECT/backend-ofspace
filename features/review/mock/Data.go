...
func (_m *Data) CreateReview(ctx context.Context, _a1 review.Core) (review.Core, error) {
...
func (_m *Data) GetAllReview(ctx context.Context, unitType uint) ([]review.Core, error) {
...
func (_m *Data) GetOneReview(ctx context.Context, id uint) (review.Core, error) {
...
func (_m *Data) UpdateReview(ctx context.Context, data review.Core) (review.Core, error) {
