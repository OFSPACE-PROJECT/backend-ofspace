...
func (_m *Business) CreateComplex(ctx context.Context, _a1 complex.Core) (complex.Core, error) {
...
func (_m *Business) GetAllComplex(ctx context.Context) ([]complex.Core, error) {
	ret := _m.Called(ctx)
...
func (_m *Business) GetComplex(ctx context.Context, id uint) (complex.Core, error) {
...
func (_m *Business) RequestComplex(ctx context.Context, id uint, name string) (complex.Core, error) {
...
func (_m *Business) SearchComplex(ctx context.Context, name string) ([]complex.Core, error) {
...
func (_m *Business) SearchComplexByAddress(ctx context.Context, address string) ([]complex.Core, error) {
...
func (_m *Business) UpdateComplex(ctx context.Context, _a1 complex.Core) (complex.Core, error) {
	ret := _m.Called(ctx, _a1)
